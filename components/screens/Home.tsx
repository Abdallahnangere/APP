...
import { Smartphone, Wifi, Phone, Mail, Headphones, MessageCircle, Shield, FileText, ChevronRight } from 'lucide-react';
...
export const Home: React.FC<HomeProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="p-6 space-y-8 pb-32">
      ...
      <BottomSheet isOpen={isSupportOpen} onClose={() => setIsSupportOpen(false)} title="Help & Legal">
          <div className="space-y-6">
              ...
              <div className="border-t border-slate-100 pt-6">
                 <p className="text-xs font-semibold text-slate-900 uppercase tracking-widest mb-3">Legal</p>
                 <div className="space-y-2">
                     <Link href="/privacy-policy" className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 text-slate-600">
                     ...
                     <Link href="/terms" className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 text-slate-600">
                         <div className="flex items-center gap-3">
